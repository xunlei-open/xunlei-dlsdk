...
下载 [`xunlei-dlsdk-java-desktop-1.0.0.zip`](https://github.com/xunlei-open/xunlei-dlsdk/releases/latest/download/xunlei-dlsdk-java-desktop-1.0.0.zip)，解压后从 `libs/` 目录按需引入目标运行环境匹配的 native JAR：
