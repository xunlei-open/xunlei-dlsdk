...
下载 [`xunlei-dlsdk-java-desktop-1.0.3.zip`](https://github.com/xunlei-open/xunlei-dlsdk/releases/latest/download/xunlei-dlsdk-java-desktop-1.0.3.zip)，解压后把桌面主包和应用要支持的平台 native 包放入应用工程的 `libs/` 目录后引入：

```gradle
implementation(files("libs/xl-dl-desktop-1.0.3.jar"))
runtimeOnly(files("libs/xl-dl-native-windows-x64-1.0.3.jar"))
```
...
| 目标平台 | JAR |
| --- | --- |
| 主包 | `xl-dl-desktop-1.0.3.jar` |
| Windows x64 | `xl-dl-native-windows-x64-1.0.3.jar` |
| Windows x86 | `xl-dl-native-windows-x86-1.0.3.jar` |
| macOS Universal | `xl-dl-native-macos-universal-1.0.3.jar` |
| Linux x64 | `xl-dl-native-linux-x64-1.0.3.jar` |
