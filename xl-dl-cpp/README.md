...
下载 [xunlei-dlsdk-cpp-1.0.1.zip](https://github.com/xunlei-open/xunlei-dlsdk/releases/latest/download/xunlei-dlsdk-cpp-1.0.1.zip)，解压后安装到本地目录：

```bash
unzip xunlei-dlsdk-cpp-1.0.1.zip
