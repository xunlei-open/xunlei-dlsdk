...
下载 [xunlei-dlsdk-swift-1.0.3.zip](https://github.com/xunlei-open/xunlei-dlsdk/releases/latest/download/xunlei-dlsdk-swift-1.0.3.zip) 并解压：

```bash
unzip xunlei-dlsdk-swift-1.0.3.zip
```
